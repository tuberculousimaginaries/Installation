...
3. These image files will be used for the upcoming installation. They will be examined, and selects will be chosen based on their merit to describe clinical visual culture.
    - A secondary concern will be to choose images that do not explicitly exploit the subject—choosing framing decisions that do less to humiliate or degrade the sitter.
...
3. Once cleaned, the excerpted texts will be read and commented upon.
    ...
    - Comments are broad, but should be quippy, commenting on granular aspects of the text,  assumptions, common metaphors, and noting recurring themes.
Comments will also be all in lower caps (for purely aesthetic differentiation).
...
5. The photoshop file will be aligned with the left part of the frame, and adjusted to better frame the text (a .7% crop on the top part of the frame).
